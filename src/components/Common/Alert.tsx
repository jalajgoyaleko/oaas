...
const Alert = () => {
  ...
  return (
    <div className="z-20 absolute top-14 sm:top-0 backdrop-blur-[32px] left-0 bottom-0 right-0 rounded-2xl flex flex-col items-center justify-center">
      ...
      <ButtonGlobal
        className="bg-sky hover:bg-black text-white font-semibold mt-8 sm:py-2 py-3 px-8 w-[80%] sm:w-[10%] text-lg sm:px-8 rounded"
        onClick={() => {
          setFinish(false);
        }}>
        Go Back
